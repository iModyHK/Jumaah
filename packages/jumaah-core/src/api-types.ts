...
export interface AuthUser {
  ...
  locale: 'ar' | 'en';
  /** Data added by an extension (hosted edition), e.g. the organisation a user administers. */
...
export interface CostEstimate {
  ...
  /** Data added by an extension (hosted edition: the platform-AI allowance). */
  ext?: Record<string, unknown>;
}
...
export interface SyncStatusDto {
  /** 'community' on a self-hosted server; extensions may report their own mode. */
  mode: string;
