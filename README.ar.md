...
> **للمساجد:** موقع [jumaah.net](https://jumaah.net) يشرح ما يفعله «جمعة» مع تجربة حية، وكيف تحصلون عليه مجاناً. هذا الملف موجّه لمن يثبّت المنصة أو يطوّرها. للأسئلة: نموذج التواصل في الموقع. للأخطاء: [افتحوا مشكلة على GitHub](https://github.com/iModyHK/Jumaah/issues).
