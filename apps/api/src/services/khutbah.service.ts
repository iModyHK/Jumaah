...
export async function createKhutbah(
  ...
  emitEvent(ctx, tenantId, 'khutbah.created', { khutbahId: khutbah.id, title: khutbah.title, gregorianDate: khutbah.gregorianDate.toISOString().slice(0, 10), targetLanguages: khutbah.targetLanguages });
